import{j as e,u as l}from"./ssg-client-BuVUAs8L.js";import{a as d}from"./style.module-C_8RmNkQ.js";import{p as c}from"./README-CmixbLha.js";const u=({className:n,...t})=>e.jsx("button",{...t,className:[d.button,n].filter(Boolean).join(" ")}),y=`import type { MyImportedTypeAlias } from './typesUtils'
...
`,I="Button Demo1 Title",M="Button demo1 description",A={code:b,title:I,desc:M},E=!0,_=Object.freeze(Object.defineProperty({__proto__:null,default:j,demoMeta:A,isDemo:E},Symbol.toStringTag,{value:"Module"}));function a(n){const t={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",p:"p",pre:"pre",strong:"strong",...l(),...n.components},{Demo:i,FileText:s,TsInfo:o}=t;return i||r("Demo",!0),s||r("FileText",!0),o||r("TsInfo",!0),e.jsxs(e.Fragment,{children:[e.jsx(t.h1,{id:"button",children:"Button"}),`
...
`})})]})}function V(n={}){const{wrapper:t}={...l(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(a,{...n})}):a(n)}function r(n,t){throw new Error("Expected "+(t?"component":"object")+" `"+n+"` to be defined: you likely forgot to import, pass, or provide it.")}const P=Object.freeze(Object.defineProperty({__proto__:null,default:V},Symbol.toStringTag,{value:"Module"})),p={};p.main=P;p.outlineInfo=c;export{p as default};
